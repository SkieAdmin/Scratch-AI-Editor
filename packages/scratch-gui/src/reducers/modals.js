...
const MODAL_AI_ABOUT = 'aiAboutModal';
const MODAL_AI_SETTINGS = 'aiSettingsModal';
...
const initialState = {
    [MODAL_AI_ABOUT]: false,
    [MODAL_AI_SETTINGS]: false,
...
const openAiAboutModal = function () {
    return openModal(MODAL_AI_ABOUT);
};
const openAiSettingsModal = function () {
    return openModal(MODAL_AI_SETTINGS);
};
const closeAiAboutModal = function () {
    return closeModal(MODAL_AI_ABOUT);
};
const closeAiSettingsModal = function () {
    return closeModal(MODAL_AI_SETTINGS);
};
